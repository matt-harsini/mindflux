          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Mindflux</span>
                <img
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl text-accent font-bold tracking-tight text- sm:text-6xl">
              mindflux
            </h1>
            <p className="mt-6 text-xl leading-8 text-white/80">
              navigate your emotional journey one day at a time
            </p>
